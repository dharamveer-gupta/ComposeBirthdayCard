package com.dharamveer.happybirthday
...
import com.dharamveer.happybirthday.ui.theme.HappyBirthdayTheme
...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier) {
    ...
    Box {
        ...
        GreetingText(
            message = "Happy Birthday Dharamveer!", from = "from DMG", modifier = Modifier
                .fillMaxSize()
                .padding(8.dp)
        )
    }
